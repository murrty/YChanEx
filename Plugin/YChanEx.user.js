...
// @name        YChanEx
// @namespace   matty
// @description Adds a download button to threads to download with YChanEx
...
// @version     1.0
// @updateURL   https://github.com/murrty/YChanEx/raw/master/Plugin/YChanEx.user.js
// @grant       none
// ==/UserScript==
...
if (document.URL.indexOf('4chan.org/') > -1) {
    chan = 0;
}
