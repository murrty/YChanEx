...
namespace YChanEx {
    class Schan : ImageBoard {
        public static string regThread = "7chan.org/[a-zA-Z0-9]*?/res/[0-9]*.[^0-9]*";

        public Schan(string url, bool isBoard) : base(url, isBoard) {
            this.Board = isBoard;
            this.imName = "7chan";
            if (!isBoard) {
        ...
        public override void download() {
            ...
            try {
                ...
                if (YCSettings.Default.htmlDownload == true && website != "")
                    FileController.downloadHTML(false, website.Replace("\"//7chan.org", "\"https://7chan.org"), this.SaveTo);
