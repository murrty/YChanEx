...
namespace BetterFolderBrowserNS {
    ...
    public class BetterFolderBrowser : CommonDialog {
        ...
        /// </summary>
        [Category("Better Folder Browsing")]
        [Editor(typeof(Editors.SelectedPathEditor), typeof(UITypeEditor))]
        [Description("Sets the initial directory displayed by the folder browser dialog.")]
        [DefaultValue("")]
...
namespace BetterFolderBrowserNS.Helpers {
    ...
    public class BetterFolderBrowserDialog {
        ...
        static BetterFolderBrowserDialog() {
            IsWine = Process.GetProcessesByName("winlogon").Length < 1; // hacky
            VistaNT = Environment.OSVersion.Platform == PlatformID.Win32NT && Environment.OSVersion.Version.Major >= 6;
        }
        ...
        private static readonly bool VistaNT;
